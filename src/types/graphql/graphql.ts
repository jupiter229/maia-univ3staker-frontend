...
export type PoolFieldsFragment = { __typename?: 'Pool', id: string, totalValueLockedUSD: any, feeTier: any, liquidity: any, totalLiquidity: any, sqrtPrice: any, tick?: any | null, token0: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any }, token1: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any } };
...
export type GetPoolQuery = { __typename?: 'Query', pool?: { __typename?: 'Pool', id: string, totalValueLockedUSD: any, feeTier: any, liquidity: any, totalLiquidity: any, sqrtPrice: any, tick?: any | null, token0: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any }, token1: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any } } | null };
...
export type GetPoolsQuery = { __typename?: 'Query', pools: Array<{ __typename?: 'Pool', id: string, totalValueLockedUSD: any, feeTier: any, liquidity: any, totalLiquidity: any, sqrtPrice: any, tick?: any | null, token0: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any }, token1: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any } }> };

export type TransactionFieldsFragment = { __typename?: 'Transaction', id: string, timestamp: any, blockNumber: any };

export type PositionFieldsFragment = { __typename?: 'Position', id: string, liquidity: any, owner: any, depositedToken0: any, depositedToken1: any, pool: { __typename?: 'Pool', id: string, totalValueLockedUSD: any, feeTier: any, liquidity: any, totalLiquidity: any, sqrtPrice: any, tick?: any | null, token0: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any }, token1: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any } }, transaction: { __typename?: 'Transaction', id: string, timestamp: any, blockNumber: any } };
...
export type GetPositionsQuery = { __typename?: 'Query', positions: Array<{ __typename?: 'Position', id: string, liquidity: any, owner: any, depositedToken0: any, depositedToken1: any, pool: { __typename?: 'Pool', id: string, totalValueLockedUSD: any, feeTier: any, liquidity: any, totalLiquidity: any, sqrtPrice: any, tick?: any | null, token0: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any }, token1: { __typename?: 'Token', decimals: any, name: string, id: string, symbol: string, volume: any, volumeUSD: any, derivedETH: any } }, transaction: { __typename?: 'Transaction', id: string, timestamp: any, blockNumber: any } }> };
...
export type GetTickQueryVariables = Exact<{
  filter?: InputMaybe<Tick_Filter>;
}>;


export type GetTickQuery = { __typename?: 'Query', ticks: Array<{ __typename?: 'Tick', tickIdx: any, liquidityNet: any, pool: { __typename?: 'Pool', id: string } }> };
...
export const GetTickDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTick"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"filter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Tick_filter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ticks"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"filter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pool"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tickIdx"}},{"kind":"Field","name":{"kind":"Name","value":"liquidityNet"}}]}}]}}]} as unknown as DocumentNode<GetTickQuery, GetTickQueryVariables>;
...
export const GqlGetTick = gql`
    query GetTick($filter: Tick_filter) {
  ticks(where: $filter) {
    pool {
      id
    }
 ...
 * __useGetTickQuery__
 *
 * To run a query within a React component, call `useGetTickQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTickQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTickQuery({
 *   variables: {
 *      filter: // value for 'filter'
 *   },
 * });
 */
export function useGetTickQuery(baseOptions?: Apollo.QueryHookOptions<GetTickQuery, GetTickQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTickQuery, GetTickQueryVariables>(GqlGetTick, options);
      }
export function useGetTickLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTickQuery, GetTickQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTickQuery, GetTickQueryVariables>(GqlGetTick, options);
        }
export type GetTickQueryHookResult = ReturnType<typeof useGetTickQuery>;
export type GetTickLazyQueryHookResult = ReturnType<typeof useGetTickLazyQuery>;
export type GetTickQueryResult = Apollo.QueryResult<GetTickQuery, GetTickQueryVariables>;
